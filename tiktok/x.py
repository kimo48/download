...
class TTDownloader(Session):
    ...
    def get_media(self):# -> list[info_videotiktok]:
        ...
        result = self.post(self.BASE_URL+'query/',data={'url': self.url, 'format': '', 'token': token[0]})
...
ttdownloader('https://www.tiktok.com/@hayat.yada/video/7128721815794371846?is_from_webapp=1&sender_device=pc')
